...
```{r}
e3_cbind = cbind(e1_cbind, e2_cbind, e2_cbind, e2_cbind)
```
...
To continue learning from the experience, my co-lead and I wanted to reach out to everyone who had participated, and ask them what they thought! However, we had an issue. Because of the pandemic, half of our data were in PDF tables, and the other half were in zoom attendance logs; not ideal.
